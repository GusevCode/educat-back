        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInformation = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhiteboardLink = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreparationPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreparationPrograms_TeacherProfiles_TeacherProfileId",
                        column: x => x.TeacherProfileId,
                        principalTable: "TeacherProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreparationPrograms_TeacherProfileId",
                table: "PreparationPrograms",
                column: "TeacherProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherStudents_TeacherProfileId",
                table: "TeacherStudents",
                column: "TeacherProfileId");
