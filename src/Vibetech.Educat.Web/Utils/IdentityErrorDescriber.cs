...
{
    /// <summary>
    /// Класс для локализации сообщений об ошибках Identity на русском языке
    /// </summary>
    public class RussianIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure()
        {
            return new IdentityError
            {
                ...
                Description = "Ошибка оптимистичной конкуренции, объект был изменен."
            };
        }
        ...
        public override IdentityError InvalidUserName(string? userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Имя пользователя '{userName}' недопустимо, может содержать только буквы и цифры."
            };
        }
